...
- Starting with version 5.4.3, Pirate Core only supports Tor version 3 hidden
...
your pirated's P2P listen port (8333 by default), and target addresses and ports
